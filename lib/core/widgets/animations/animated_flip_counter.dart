...
class AnimatedFlipCounter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<int> digits = value == 0 ? <int>[0] : <int>[];
    int v = value.abs();
    while (v > 0) {
      digits.add(v);
      v = v ~/ 10;
    ...
    final List<Widget> integerWidgets = <Widget>[];
    for (int i = 0; i < digits.length - fractionDigits; i++) {
      final _SingleDigitFlipCounter digit = _SingleDigitFlipCounter(
        key: ValueKey<int>(digits.length - i),
        ...
        children: <Widget>[
          ...
          ClipRect(
            child: TweenAnimationBuilder<double>(
              duration: duration,
              tween: Tween<double>(end: value < 0 ? 1.0 : 0.0),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty<num>("value", value))
      ..add(StringProperty("decimalSeparator", decimalSeparator))
      ...
      ..add(IntProperty("fractionDigits", fractionDigits))
      ..add(IntProperty("wholeDigits", wholeDigits))
      ..add(StringProperty("thousandSeparator", thousandSeparator))
      ..add(
