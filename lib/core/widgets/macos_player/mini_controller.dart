...
// ignore_for_file: parameter_assignments, discarded_futures
...
class MiniController extends ValueNotifier<VideoPlayerValue> {
    ...
    void eventListener(VideoEvent event) {
      switch (event.eventType) {
        case VideoEventType.initialized:
          ...
          _platform.setVolume(_textureId, 1);
  ...
  Future<Duration?> get position async => _platform.getPosition(_textureId);
...
class _MacVideoPlayerState extends State<MacVideoPlayer> {
  ...
  Widget build(BuildContext context) =>
      _textureId == MiniController.kUninitializedTextureId
          ? Container()
