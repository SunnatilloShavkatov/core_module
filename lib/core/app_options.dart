import "package:core_module/core/widgets/keyboard/keyboard_dismiss.dart";
...
class AppOptions extends Equatable {
  ...
  @override
  List<Object> get props => <Object>[themeMode, locale, sound];
}
...
class _ModelBindingState extends State<ModelBinding> {
  ...
  Widget build(BuildContext context) => KeyboardDismiss(
        ...
        //     secondaryColor: colorLightScheme.primary,
        //   ),
        //   isScreen: true,
        //   dio: sl<Dio>(),
        //   navigatorKey: rootNavigatorKey,
        //   options: WiredashOptionsData(locale: currentModel.locale),
